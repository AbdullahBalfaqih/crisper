...
export const PrintOnlineReceipt = React.forwardRef<HTMLDivElement, PrintableReceiptProps>(
      ...
      <div ref={ref}>
        ...
        <div className="receipt-container-customer">
            <div className="text-center header-section">
                ...
                <h1 className="text-xl font-bold">كرسبر</h1>
                <p className="text-sm">حي الوحدة قبلي مستشفى بن زيلع</p>
                <h2 className="text-lg font-bold mt-1">فاتورة طلب أونلاين</h2>
            </div>
            ...
            <div className="details-grid">
                ...
                <div>الفاتورة:</div><div>{receiptNumber}</div>
                <div>الكاشير:</div><div>{cashierName}</div>
                <div>نقطة البيع:</div><div>WEB</div>
...
PrintOnlineReceipt.displayName = 'PrintOnlineReceipt';
