    ...
    <>
      <div className="bg-background min-h-screen font-body text-foreground">
        <div className="container mx-auto max-w-lg p-4 pb-40">
          ...
          <>
              {/* Discount Info */}
              <div className="bg-amber-100 border border-amber-200 text-amber-800 text-sm rounded-lg p-3 flex items-start gap-2 mb-6">
                <Info size={20} className="shrink-0 mt-0.5" />
                <span>تم خصم الخصم تلقائيًا على عناصر التسوق الخاصة بك!</span>
              </div>
                    ...
                    <div key={item.id + (item.notes || '')} className={cn("bg-card p-3 rounded-xl flex items-center gap-4 shadow-sm", isOutOfStock && "ring-2 ring-destructive")}>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-baseline gap-2 mt-1 text-sm">
                            <span className="text-primary font-bold">{item.price.toFixed(2)} ر.ي</span>
                        </div>
